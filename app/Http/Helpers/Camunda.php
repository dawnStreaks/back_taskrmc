...
class Camunda {
    ...
    public function __construct($engineUrl) {
        $this->engineUrl = env('CAMUNDA_API_URL');
    }
    ...
    public function deleteAuthorization($id) {
      ...
      return $this->restRequest('DELETE', $query);
    }
    ...
    public function checkAuthorization($parameterArray) {
        ...
        foreach($checkerArray AS $value) {
            if(isset($parameterArray[$value]) && ($parameterArray[$value] != null || $parameterArray[$value] != '')) {
                continue;
            } else {
    ...
    public function updateAuthorization($id, $parameterArray) {
        $query = 'authorization/'.$id;
      return $this->restRequest('PUT', $query, $parameterArray);
    }
    ...
    public function getinstanceBpmnXml($id) {
        $query = 'process-instance/'.$id.'/activity-instances';
        return $this->restRequest('GET', $query, null);
    }

    public function getDefinationCount($parameterArray = null) {
        $query = 'process-instance/count';
        return $this->restRequest('GET', $query, $parameterArray);
    }

    public function getDefinationStatistic($id) {
        $query = 'process-definition/'.$id.'/statistics';
        return $this->restRequest('GET', $query, null);
    }

    public function getHistoryProcessDefination($paramas) {
        $query = '/history/process-instance';
        return $this->restRequest('GET', $query, $paramas);
    }

    public function getProcessinstanceHistory($id) {
        $query = '/history/process-instance/'.$id;
        return $this->restRequest('GET', $query, null);
    }
     ...
     * @return mixed returns the server response
     */
    public function startProcessInstance($key,$tenantId, $processVariables = null) {
    ...
    public function singleTaskFormVariable($id) {
        $query = 'task/'.$id.'/form-variables';
        return $this->restRequest('GET', $query);
    }

    public function getIdentityLinks($id) {
        $query = '/task/'.$id.'/identity-links';
        return $this->restRequest('GET', $query);
    }

    public function addIdentityLink($id, $parameterArray) {
        $query = '/task/'.$id.'/identity-links';
        return $this->restRequest('POST', $query, $parameterArray);
    }
    public function removeIdentityLink($id, $parameterArray) {
        $query = '/task/'.$id.'/identity-links/delete';
        return $this->restRequest('POST', $query, $parameterArray);
    }

    public function getTaskUserOperations($parameterArray) {

        $query = 'history/user-operation';
        return $this->restRequest('GET', $query, $parameterArray);
    }


    public function setFollowAndDueDate($id, $parameterArray) {
        $query = 'task/'.$id;
        return $this->restRequest('PUT', $query, $parameterArray);
    }

    public function submitTask($id,$parameterArray) {
       /* var_dump($parameterArray);
        die;*/
        $query = 'task/'.$id.'/submit-form';
        return $this->restRequest('POST', $query, $parameterArray);
    }

    public function getCommentList($id,$parameterArray = null) {
        $query = 'task/'.$id.'/comment';
        return $this->restRequest('GET', $query, $parameterArray);
    }

    public function createComment($id,$parameterArray) {
        $query = 'task/'.$id.'/comment/create';
        return $this->restRequest('POST', $query, $parameterArray);
    }
    ...
    public function addGroupMember($groupId, $userId) {
      ...
      return $this->restRequest('PUT', $query, null);
    }

    public function getGroupMember($parameterArray) {
        $query = 'group';
        return $this->restRequest('GET', $query, $parameterArray);
    }
    ...
    public function deleteGroupMember($groupId, $userId) {
        $query = 'group/'.$groupId.'/members/'.$userId;
        return $this->restRequest('DELETE', $query, null);
    }

    public function addTenantMember($tenantId, $userId) {
        $query = "tenant/".$tenantId."/user-members/".$userId;
      return $this->restRequest('PUT', $query, null);
    }
    public function addTenantGroupMember($tenantId, $groupId) {
        $query = "tenant/".$tenantId."/group-members/".$groupId;
      return $this->restRequest('PUT', $query, null);
    }
    ...
    private function restRequest($method, $query, $parameters = null) {
        ...
        if($http_status_code > 199 AND $http_status_code < 300){
